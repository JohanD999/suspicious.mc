...
const config = {
    serverInfo: {
        serverLogoImageFileName: "logo2.png", /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        serverName: "Suspicious MC", /*Server name*/
        serverIp: "suspicious.mc.mine.bz:25572",
        /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
         /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
        ...
        Founder: [
            {
                inGameName: "Spartan",
                rank: "Founder",
                skinUrlOrPathToFile: "images/skins/spartan.png",
                rankColor: "rgb(205, 20, 20)"
            },
            {
                inGameName: "Lawlet",
                rank: "Founder",
                skinUrlOrPathToFile: "images/skins/obito.png",
                rankColor: "rgb(205, 20, 20)"
            }
        ],
        developers: [
            {
                inGameName: "Barkat",
                rank: "Lead Developer",
                skinUrlOrPathToFile: "images/skins/barkat.png",
                rankColor: "rgb(149, 104, 0)"
            },
            {
                inGameName: "Johan",
                rank: "Lead Developer",
                skinUrlOrPathToFile: "images/skins/johan2.png",
                rankColor: "rgb(149, 104, 0)"
            }
        ],
        Management: [
            {
                inGameName: "Vegeta",
                rank: "Management Director",
                skinUrlOrPathToFile: "images/skins/vegeta.png",
                rankColor: "rgb(137, 16, 107)"
            }
        ]
    },
...
function createSnowflake() {
  ...
  snow.animate(
    [
      ...
      {
        transform: `translate(${drift}px, 110vh) rotate(${rotation}deg)`
      }
    ],
    {
...
const SERVER_IP = "suspicious.mc.mine.bz:25572";
